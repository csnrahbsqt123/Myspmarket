...
class Category(BaseModel):
    ...
    describe = models.CharField(verbose_name='描述',
                             max_length=200,
                             null=True,
                             blank=True
                             )
...
class GoodsSKU(BaseModel):
    ...
    describe = models.CharField(verbose_name="商品的简介",
                             max_length=200,
                             null=True,
                             blank=True,
                             )
...
class Activity(BaseModel):
    ...
    url_site = models.CharField(verbose_name='活动的url地址', max_length=200,null=True)
...
class ActivityZone(BaseModel):
    ...
    describe = models.CharField(verbose_name="活动专区的简介",
                             max_length=200,
                             null=True,
                             blank=True,
                             )
